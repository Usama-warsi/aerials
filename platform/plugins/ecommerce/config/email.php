...
return [
    ...
    'templates' => [
        ...
        'download_gift_products' => [
            'title' => 'Sending Gift Code',
            'description' => 'Send email Gift Code when guest makes a purchase',
            'subject' => 'Check gift products you have purchased',
            'can_off' => false,
            'variables' => [
               'code'=>'code',
            ],
