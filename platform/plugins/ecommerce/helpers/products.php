...
if (! function_exists('get_all_product_categories')) {
    function get_all_product_categories(): Collection|LengthAwarePaginator|Product|null
    {
...
if (! function_exists('get_all_parent_product_categories')) {
    function get_all_parent_product_categories(): Collection|LengthAwarePaginator|Product|null
    {
        return ProductCategory::query()
            ->wherePublished()
            ->where('parent_id', 0)
...
if (! function_exists('get_featured_product_categories')) {
    function get_featured_product_categories(): Collection|LengthAwarePaginator|Product|null
    {
        return ProductCategory::query()
