...
class ShippingRuleTypeEnum extends Enum
{
    ...
    public function toUnit(): ?string
    {
        return match ($this->value) {
            ...
            self::BASED_ON_LOCATION => ecommerce_weight_unit(),
            default => '',
        };
    }
    ...
    public function toUnitText(mixed $value): mixed
    {
        return match ($this->value) {
            ...
            self::BASED_ON_LOCATION => number_format($value) . ' ' . $this->toUnit(),
            default => $value,
        };
    }
    ...
    {
        return match ($this->value) {
            self::BASED_ON_PRICE, self::BASED_ON_LOCATION, self::BASED_ON_WEIGHT => true,
            default => false,
        };
    }
