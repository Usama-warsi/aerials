...
namespace Botble\Englandlogistics\Commands;
...
#[AsCommand('cms:englandlogistics:init', 'Englandlogistics initialization')]
class InitEnglandlogisticsCommand extends Command implements PromptsForMissingInput
{
    ...
    public function handle(): int
    {
        ...
        $settings = [
            ...
            'shipping_englandlogistics_api_key' => $key,
            'shipping_englandlogistics_status' => $key ? '1' : '0',
        ];
