...
class EnglandlogisticsWebhookController extends BaseController
{
    ...
    protected function transactionUpdated(Shipment $shipment, array $data)
    {
        ...
        $this->shipmentHistoryRepository->createOrUpdate([
            ...
            'description' => trans('plugins/englandlogistics::englandlogistics.transaction.updated', [
    ...
    protected function trackUpdated(Shipment $shipment, array $data)
    {
        ...
        $this->shipmentHistoryRepository->createOrUpdate([
            ...
            'description' => trans('plugins/englandlogistics::englandlogistics.tracking.statuses.' . Str::lower($status)),
            'order_id' => $shipment->order_id,
            'user_id' => 0,
            'shipment_id' => $shipment->id,
        ]);
